...
class Settings(BaseSettings):
    ...
    video_motion_threshold: float = 8.0  # per-pixel diff threshold for "still" detection
    video_min_still_seconds: float = 0.25  # minimum pause duration to count as a still window
